...
class AddWindStationActivity : AppCompatActivity() {
...
//            Intent.ACTION_VIEW -> {
//                println(">>>> Intent.ACTION_VIEW")
//                Toast.makeText(applicationContext,"Opened by assistant", Toast.LENGTH_LONG).show()
//            }
//            // Otherwise start the app as you would normally do.
//            else -> println(">>>> Intent. ${action.toString()}")
//        }
//    }
